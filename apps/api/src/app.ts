...
// Construção do app separada do bootstrap (app.listen) em index.ts — permite
// testes de integração (supertest) importarem o app sem abrir uma porta real
// nem depender do servidor de dev estar de pé numa porta fixa.
